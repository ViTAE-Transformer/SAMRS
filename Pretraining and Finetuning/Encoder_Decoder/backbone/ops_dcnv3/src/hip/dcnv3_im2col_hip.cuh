...
template <typename scalar_t>
void dcnv3_im2col_cuda(hipStream_t stream, const scalar_t *data_im,
   ...
   hipLaunchKernelGGL(( dcnv3_im2col_gpu_kernel<scalar_t>)
        , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
...
void dcnv3_col2im_cuda(
    hipStream_t stream, const scalar_t *grad_col, const scalar_t *data_im,
    const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
    const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
    const int pad_w, const int dilation_h, const int dilation_w,
    ...
    if (group_channels > 1024) {
        if ((group_channels & 1023) == 0) {
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_reduce_v2_multi_blocks<scalar_t>)
           ...
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_gm<scalar_t>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
        ...
        case 1:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 1>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 2:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 2>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 4:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 4>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 8:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 8>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 16:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 16>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 32:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1<scalar_t, 32>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 64:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 64>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 128:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 128>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 256:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 256>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 512:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t, 512>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
                             pad_h, pad_w, dilation_h, dilation_w, group,
            ...
            break;
        case 1024:
           hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2<scalar_t,
                                                                  1024>)
                , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads), 0,
                   stream, num_kernels, grad_col, data_im, data_offset,
                             data_mask, kernel_h, kernel_w, stride_h, stride_w,
        ...
        default:
            if (group_channels < 64) {
               hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_reduce_v1<scalar_t>)
                    , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads),
                       num_threads * 3 * sizeof(opmath_t), stream, 
                        num_kernels, grad_col, data_im, data_offset, data_mask,
                        kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w,
               ...
               hipLaunchKernelGGL(( dcnv3_col2im_gpu_kernel_shm_reduce_v2<scalar_t>)
                    , dim3(GET_BLOCKS(num_actual_kernels, num_threads)), dim3(num_threads),
                       num_threads * 3 * sizeof(opmath_t), stream, 
                        num_kernels, grad_col, data_im, data_offset, data_mask,
                        kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w,
