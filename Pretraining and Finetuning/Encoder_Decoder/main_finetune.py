...
if args.dataset == 'potsdam':
    ...
    trn_dataset = ISPRSDataset(img_size = IMAGE_SIZE, split='train', data_root=root, transform=train_trfm)
    val_dataset = ISPRSDataset(img_size = IMAGE_SIZE, split='val', data_root=root, transform=val_trfm)
elif args.dataset == 'vaihingen':
    classes = 5
    root = ''
    trn_dataset = ISPRSDataset(img_size = IMAGE_SIZE, split='train', data_root=root, transform=train_trfm)
    ...
    trn_dataset = ISAIDDataset(img_size = IMAGE_SIZE, split='train', data_root=root, transform=train_trfm)
    val_dataset = ISAIDDataset(img_size = IMAGE_SIZE, split='val', data_root=root, transform=val_trfm)
else:
    raise NotImplementedError
